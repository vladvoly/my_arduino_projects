...
#### В папке будет расположен код и краткая статья на тему ролика.
---

- [YouTube](https://youtu.be/4hwFWdwO0B4 "Видео на YouTube") - SIM800L. Простой пример на Arduino. - [Схема и код](../main/all_here/140/note.md)  
